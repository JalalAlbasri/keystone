...
module.exports = Field.create({
  ...
  getOptions() {
    ...
    var toolbar = options.overrideToolbar
      ? ""
      : "bold italic | alignleft aligncenter alignright | bullist numlist | outdent indent | removeformat | link ";
    var i;
  ...
  renderValue() {
    ...
    return <FormInput multiline noedit dangerouslySetInnerHTML={htmlValue} />;
  }
});
